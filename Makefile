...
data/raw/gspc_raw.csv data/raw/cpi_raw.csv data/raw/interest_raw.csv: 
...
data/processed/cleaned_data.csv: data/raw/gspc_raw.csv data/raw/cpi_raw.csv data/raw/interest_raw.csv
...
data/processed/processed_data.csv: data/processed/cleaned_data.csv
	python src/feature_extract.py \
	--data_path='data/processed/cleaned_data.csv' \
	--out_path='data/processed/processed_data.csv'

data/processed/x_train.csv data/processed/y_train.csv data/processed/x_test.csv data/processed/y_test.csv: \
...
results/figures/time.png results/figures/hist.png results/figures/scat.png: \
data/processed/processed_data.csv data/processed/x_train.csv data/processed/y_train.csv
	python src/eda.py \
	--processed_data_path='data/processed/processed_data.csv' \
	--x_train_path='data/processed/x_train.csv' \
	--y_train_path='data/processed/y_train.csv' \
...
results/tables/mdl_result.csv: data/processed/x_train.csv data/processed/y_train.csv \
...
report/_build/html/index.html: report/predicting_direction_of_stock_price_from_inflation_rate_and_interest_rate.ipynb \
results/tables/mdl_result.csv \
results/figures/time.png \
results/figures/hist.png \
results/figures/scat.png \
data/processed/processed_data.csv 
